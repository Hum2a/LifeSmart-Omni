...
const Question8 = ({ onAnswered }) => {
  const question = {
    text: 'What is a dividend?',
    options: [
      "A) A fee charged by a broker",
      "B) A portion of company profits paid to shareholders",
      "C) The total value of your investment",
      "D) A type of investment loss"
    ]
  };
  ...
  const handleAnswer = async (option) => {
    ...
    await saveAnswer(8, answerLetter); // Save the answer to Firestore
