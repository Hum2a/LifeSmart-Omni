    ...
    <div className="question2-container">
      ...
      {!showResults ? (
        ...
        <div className="question2-result-section">
          ...
          <p className="question2-correct-answer-description">
            Here's how to calculate it:
            <br />
            1. First £10,000: No tax (0%)
            <br />
            2. Next £30,000 (£10,000 - £40,000): 20% tax = £6,000
            <br />
            3. Remaining £20,000 (£40,000 - £60,000): 40% tax = £8,000
            <br />
            Total tax = £14,000
            <br />
            Take-home pay = £60,000 - £14,000 = £46,000
          </p>
            ...
            {teams.map((team, index) => (
              <div key={team.name} className="question2-team-answer-box">
                ...
                <div className={teamAnswers[index] === correctAnswer ? 'question2-correct' : 'question2-incorrect'}>
                  {teamAnswers[index] || 'No answer'}
                </div>
              </div>
            ))}
          </div>

          <button className="question2-next-button" onClick={nextQuestion}>Next Question</button>
        </div>
      )}
    </div>
  );
